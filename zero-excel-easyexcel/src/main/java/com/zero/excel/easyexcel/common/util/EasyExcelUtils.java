package com.zero.excel.easyexcel.common.util;
...
public class EasyExcelUtils {
    ...
    public static class TestPathBuild {
        ...
        public String getPath() {
            ...
            if (subPath.size() == 1) {
                return EasyExcelUtils.class.getResource("/").getPath() + subPath.get(0);
            }
            StringBuilder path = new StringBuilder(EasyExcelUtils.class.getResource("/").getPath());
